...
def updateAttitude(Cbi_hat,b_d,g_i,norm_accel,omega_measured,norm_magne):
    ...
    return Cbi_hat_new,b_b,g_b

def updateControl(Cbi_hat,C_d,b_d,g_i,b_b,g_b,omega_measured):
...
if __name__ == '__main__':
    ...
    while(True):
        ...
        if(len(line)==18):
            ...
            Cbi_hat_new,b_b,g_b=updateAttitude(Cbi_hat,g_i,b_d,norm_accel,omega_measured,norm_magna)

            tau=updateControl(Cbi_hat,C_d,b_d,g_i,b_b,g_b,omega_measured)
